...
def sharp_image_with_laplacian(image):
    kernel_size = 3
    scale = 0
    delta = 0
    ddepth = cv2.CV_16S
...
def remove_noise_and_get_grey_img(image):
    ...
    #cv2.waitKey(0)
    img_noiese_removed = cv2.bilateralFilter(img_loged, 5, 75, 95)
...
if __name__ == "__main__":
    ...
    sharp_grey_laplacian = sharp_image_with_laplacian(image)
