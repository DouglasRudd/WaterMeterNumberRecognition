...
class RoiAndCordinatesGroupsOffFiveByY(object):
    ...
    def __kick_out_roi_that_is_most_dissimilar(self, group_sorted_by_area):
        ...
        while len(group_sorted_by_area) > 5:
            ...
            if abs(group_sorted_by_area[0].w*group_sorted_by_area[0].h - average_area_roi_group) > \
                    abs(group_sorted_by_area[last_index].w*group_sorted_by_area[last_index].h - average_area_roi_group):
